...
public class NullReader extends Reader {
	 ...
	 *
	 * @param readlimit
	 *            The number of characters before this marked position is
	 *            invalid.
	 ...
	 *         file has been reached and <code>throwEofException</code> is set
	 *         to {@code false}.
	 * @throws EOFException
	 *             if the end of file is reached and
	 *             <code>throwEofException</code> is set to {@code true}.
	 ...
	 *         {@code false}
	 * @throws EOFException
	 *             if <code>throwEofException</code> is set to {@code true}.
	 */
