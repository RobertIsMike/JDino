...
public class MagicNumberFileFilter extends AbstractFileFilter implements
	 ...
	 *             if <code>magicNumber</code> is {@code null}, or contains no
	 *             bytes.
	 */
	 ...
	 * 
	 * @param magicNumber
	 *            the magic number to look for in the file. The string is
	 *            converted to bytes using the platform default charset.
	 *
	 * @throws IllegalArgumentException
	 *             if <code>magicNumber</code> is {@code null} or the empty
	 *             String.
	 */
	 ...
	 *            converted to bytes using the platform default charset.
	 * @param offset
	 *            the byte offset in the file to start comparing bytes.
	 * 
	 * @throws IllegalArgumentException
	 *             if <code>magicNumber</code> is {@code null} or the empty
	...
	public MagicNumberFileFilter(String magicNumber, long offset) {
		...
		magicNumbers = magicNumber.getBytes(); // uses the platform default charset
		byteOffset = offset;
	}
