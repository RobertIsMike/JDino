 ...
 */
package org.apache.io.comparator;
...
public class SizeFileComparator extends AbstractFileComparator implements Serializable {
	 ...
	 *
	 * @param sumDirectoryContents
	 *            {@code true} if the sum of the directoryies contents should be
	 *            calculated, otherwise {@code false} if directories should be
	 *            treated as size zero (see
	 ...
	 *         second, zero if the lengths are the same and a positive value if
	 *         the first files length is greater than the second file.
	 * 
	 */
	@Override
