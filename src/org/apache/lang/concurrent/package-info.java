 ...
 * All these classes implement the {@link org.apache.lang.concurrent.ConcurrentInitializer} interface which provides just a
 * single method:
 * </p>
 *
 * <pre>
 ...
 * By calling the {@link org.apache.lang.concurrent.ConcurrentInitializer#get() get()} method the object managed by the initializer can be obtained.
 * There are different implementations of the interface available
 * addressing various use cases:
 * </p>
 *
 * <p> {@link org.apache.lang.concurrent.ConstantInitializer} is a very straightforward implementation of the <code>ConcurrentInitializer</code> interface:
 ...
 * </p>
 *
 * <p>The {@link org.apache.lang.concurrent.LazyInitializer} class can be used to defer the creation of an object until it is actually used.
 ...
 * <code>LazyInitializer</code> declares an abstract {@link org.apache.lang.concurrent.LazyInitializer#initialize() initialize()} method which we have to implement to create the messaging service object:</p>
 *
 * <pre>
 * <code>
 ...
 * </pre>
 *
 * <p>The {@link org.apache.lang.concurrent.AtomicInitializer} class is very similar to <code>LazyInitializer</code>.
 ...
 * Again there is an abstract {@link org.apache.lang.concurrent.AtomicInitializer#initialize() initialize()} method which has to be implemented by concrete subclasses in order to create and initialize the managed object.
 ...
 *
 * <p>With {@link org.apache.lang.concurrent.AtomicSafeInitializer} there is yet another variant implementing the lazy initializing pattern.
 ...
 * The name &quot;Safe&quot; is derived from the fact that it implements an additional check which guarantees that the {@link org.apache.lang.concurrent.AtomicSafeInitializer#initialize() initialize()} method is called only once.
 ...
 *
 * <p>Another implementation of the <code>ConcurrentInitializer</code> interface is {@link org.apache.lang.concurrent.BackgroundInitializer}.
 * It is again an abstract base class with an {@link org.apache.lang.concurrent.BackgroundInitializer#initialize() initialize()} method that has to be defined by concrete subclasses.
 ...
 * </pre>
 *
 * <p> Related to <code>BackgroundInitializer</code> is the {@link org.apache.lang.concurrent.MultiBackgroundInitializer} class.
 ...
 * Then an arbitrary number of <code>BackgroundInitializer</code> objects is added using the {@link org.apache.lang.concurrent.MultiBackgroundInitializer#addInitializer(String, BackgroundInitializer)} method.
 * When adding an initializer a string has to be provided which is later used to obtain the result for this initializer.
 * When all initializers have been added the {@link org.apache.lang.concurrent.MultiBackgroundInitializer#start()} method is called.
 ...
 * <code>get()</code> returns an object of type {@link org.apache.lang.concurrent.MultiBackgroundInitializer.MultiBackgroundInitializerResults}.
 ...
 * There is the {@link org.apache.lang.concurrent.ConcurrentUtils} class with a bunch of static utility methods.
 ...
 * </p>
 *
 * <p>The {@link org.apache.lang.concurrent.ConcurrentUtils#extractCause(java.util.concurrent.ExecutionException)} method does this work for you.
 ...
 * Otherwise, an instance of {@link org.apache.lang.concurrent.ConcurrentException} is created and initialized with the root cause
 ...
 * For users who prefer runtime exceptions in general there is also an {@link org.apache.lang.concurrent.ConcurrentUtils#extractCauseUnchecked(java.util.concurrent.ExecutionException)} method which behaves like <code>extractCause()</code>, but returns the unchecked exception {@link org.apache.lang.concurrent.ConcurrentRuntimeException} instead.</p>
 *
 * <p>In addition to the <code>extractCause()</code> methods there are corresponding {@link org.apache.lang.concurrent.ConcurrentUtils#handleCause(java.util.concurrent.ExecutionException)} and {@link org.apache.lang.concurrent.ConcurrentUtils#handleCauseUnchecked(java.util.concurrent.ExecutionException)} methods.
 ...
 * </pre>
 *
 * <p>Using the {@link org.apache.lang.concurrent.ConcurrentUtils#initializeUnchecked(ConcurrentInitializer)} method, this becomes:</p>
 *
 * <pre>
 * <code>
 * ConcurrentInitializer&lt;MyClass&gt; initializer = ...;
 ...
 *
 * <p> With {@link org.apache.lang.concurrent.BasicThreadFactory} Commons Lang has an implementation of <code>ThreadFactory</code> that works out of the box for many common use cases.
 ...
 * Instances of <code>BasicThreadFactory</code> are created and configured using the nested {@link org.apache.lang.concurrent.BasicThreadFactory.Builder} class.
 ...
 * An instance can wrap another <code>ThreadFactory</code> implementation; this is achieved by calling the builder's {@link org.apache.lang.concurrent.BasicThreadFactory.Builder#wrappedFactory(java.util.concurrent.ThreadFactory) wrappedFactory(ThreadFactory)} method.
 ...
 *
 * <p> {@link org.apache.lang.concurrent.TimedSemaphore} allows restricted access to a resource in a given time frame.
 ...
 * Now multiple threads access the semaphore and call its {@link org.apache.lang.concurrent.TimedSemaphore#acquire()} method.
 ...
 * </pre>
 *
 * <p>With the {@link org.apache.lang.concurrent.TimedSemaphore#setLimit(int)} method the number of permits allowed for a time frame can be changed.
 ...
 */
package org.apache.lang.concurrent;
