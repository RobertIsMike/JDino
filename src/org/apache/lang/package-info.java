 ...
 * However {@link org.apache.lang.CharSet} is not currently guaranteed thread-safe under all circumstances.</p>
 *
 * <p>The top level package contains various Utils classes, whilst there are various subpackages including {@link org.apache.lang.math}, {@link org.apache.lang.concurrent} and {@link org.apache.lang.builder}.
 ...
 * The first is {@link org.apache.lang.StringUtils}, oodles and oodles of functions which tweak, transform, squeeze and cuddle {@link java.lang.String java.lang.Strings}.
 * In addition to StringUtils, there are a series of other String manipulating classes; {@link org.apache.lang.RandomStringUtils} and {@link org.apache.lang.StringEscapeUtils StringEscapeUtils}.
 ...
 * StringUtils' {@link org.apache.lang.StringUtils#capitalize(String)}, {@link org.apache.lang.StringUtils#substringBetween(String, String)}/{@link org.apache.lang.StringUtils#substringBefore(String, String) Before}/{@link org.apache.lang.StringUtils#substringAfter(String, String) After}, {@link org.apache.lang.StringUtils#split(String)} and {@link org.apache.lang.StringUtils#join(Object[])} are good methods to begin with.
 ...
 * {@link org.apache.lang.CharUtils} exists for this purpose, while {@link org.apache.lang.CharSetUtils} exists for set-manipulation of Strings.
 ...
 *
 * <p>{@link org.apache.lang.CharRange} and {@link org.apache.lang.CharSet} are both used internally by CharSetUtils, and will probably rarely be used.</p>
 *
 ...
 *
 * <p>The {@link org.apache.lang.CharEncoding} class is also used to interact with the Java environment and may be used to see which character encodings are supported in a particular environment. </p>
 *
 ...
 *
 * <p>Would you believe it, {@link org.apache.lang.ObjectUtils} contains handy functions for Objects, mainly null-safe implementations of the methods on {@link java.lang.Object}.</p>
 *
 * <p>{@link org.apache.lang.ClassUtils} is largely a set of helper methods for reflection.
 ...
 *
 * <p>Next up, {@link org.apache.lang.ArrayUtils}.
 ...
 * </ul>
 *
 * <p>Lastly, {@link org.apache.lang.ArrayUtils#toMap(Object[])} is worthy of special note.
 ...
 * </pre>
 *
 * <p>Our final util class is {@link org.apache.lang.BooleanUtils}.
 * It contains various Boolean acting methods, probably of most interest is the {@link org.apache.lang.BooleanUtils#toBoolean(String)} method which turns various positive/negative Strings into a Boolean object, and not just true/false as with Boolean.valueOf.</p>
 *
 ...
 * <p>The {@link org.apache.lang.BitField} class provides a wrapper class around the classic bitmask integer, whilst the {@link org.apache.lang.Validate} class may be used for assertions (remember, we support Java 1.2). </p>
 *
 * @since 1.0
